  ...
  suggestions: Suggestion[] = [
    {
      ...
      pour renforcer les liens entre les membres de l'équipe.`,
      category: 'Événements',
    ...
    },
    {
      ...
      pour motiver les employés et reconnaître leurs efforts.`,
...
favorites: Suggestion[] = [];
  ...
  addToFavorites(suggestion: Suggestion): void {
    if (!this.favorites.some(fav => fav.id === suggestion.id)) {
